...
class Test_Logimax:
    ...
    def test_BranchTransfer_Purchase_item(self,booting_function):   
        ...
        sleep(6)
        self.driver.find_element(by=By.ID,value=locators.Logi_Locators().Repair_order).click()
        sleep(5)
        ...
        sleep(5)
        self.driver.find_element(by=By.ID,value=locators.Logi_Locators().order_no).send_keys(data.Logi_Data().order_id) 
        sleep(5)
        self.driver.find_element(by=By.XPATH,value=locators.Logi_Locators().search).click()
        sleep(5)
        ...
        print("Repair item Branch Transfer Successfully    From_Branch : {a}, To_Branch : {b}, order_no : {c}, ". format(a ='Head OFFICE',  b = 'CHINNA ANNAN JEWELLERY', c = data.Logi_Data().order_id ))
